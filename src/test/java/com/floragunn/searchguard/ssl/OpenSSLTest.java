...
public class OpenSSLTest extends SSLTest {
    ...
    public void testNodeClientSSLwithOpenSslTLSv13() throws Exception {
        ...
        final Settings settings = Settings.builder().put("searchguard.ssl.transport.enabled", true)
                ...
                .putList(SSLConfigConstants.SEARCHGUARD_SSL_TRANSPORT_ENABLED_CIPHERS, "TLS_CHACHA20_POLY1305_SHA256")
                .build();
        ...
        try (Node node = new PluginAwareNode(tcSettings, null,  Netty4Plugin.class, SearchGuardSSLPlugin.class).start()) {
